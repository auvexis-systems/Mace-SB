...
const NAV_ITEMS = [
  ...
  { href: "/admin/cards", label: "Angebote", icon: LayoutGrid },
          ...
          <div className="flex flex-col md:flex-row min-h-dvh">
            <aside className="hidden md:flex md:w-60 md:flex-col md:border-r md:border-white/10 md:p-4 md:gap-1">
              <div className="px-2 py-3 mb-2">
                ...
                <p className="text-xs text-white/40">Meine Website</p>
              </div>
              ...
              <div className="mt-auto flex flex-col gap-1 pt-4 border-t border-white/10">
                ...
                >
                  <ExternalLink className="w-4.5 h-4.5" /> Öffentliche Seite ansehen
                </a>
